...
function setupScene(gltf) {
    ...
    const container = document.getElementById('avatar-container1');
   ...
   // Create pedestal
    ...
    const waveClip = THREE.AnimationClip.findByName(clips, 'sittingp');
    const stumbleClip = THREE.AnimationClip.findByName(clips, 'talking');
