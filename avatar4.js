...
function setupScene(gltf) {
    ...
    const container = document.getElementById('avatar-container4');
   ...
   // Create pedestal
    ...
    const waveClip = THREE.AnimationClip.findByName(clips, 'agree');
    const stumbleClip = THREE.AnimationClip.findByName(clips, 'look');
